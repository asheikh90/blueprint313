...
const Benefits = () => {
  const benefits = [
    {
      icon: <FaRegLightbulb className="text-4xl text-primary-600 mb-4" />,
    ...
    {
      icon: <FaRegClock className="text-4xl text-primary-600 mb-4" />,
      title: "Time Freedom",
    ...
    {
      icon: <FaHandHoldingUsd className="text-4xl text-primary-600 mb-4" />,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <div key={index} className="bg-secondary-800 rounded-xl p-6 shadow-md transform transition-all duration-300 hover:scale-105 hover:shadow-glow border border-secondary-700">
        ...
        <div className="mt-16 bg-secondary-900 rounded-xl shadow-md p-8 border border-secondary-800">
